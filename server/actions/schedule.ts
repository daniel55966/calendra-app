...
export async function getSchedule(userId: string): Promise<FullSchedule> {
  // Query the ScheduleTable for the first record that matches the user's ID and load the related 'availabilities' data
...
export async function saveSchedule(
  unsafeData: z.infer<typeof scheduleFormSchema> // Accepts invalidated form data
) {
  try {
